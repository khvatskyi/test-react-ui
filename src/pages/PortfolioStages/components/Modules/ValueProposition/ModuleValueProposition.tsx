...
import { addUserMessage, loadValuePropositionChat, selectChatContext, selectValuePropositionChatExample, sendMessageValuePropositionChatToAi } from '../../../../../store/ai.slice';
...
export default function ModuleValueProposition({ portfolioId }: IModuleValuePropositionProps) {
  ...
  const onSendMessage = (message: string) => {
    ...
    return dispatch(sendMessageValuePropositionChatToAi(message));
  };
